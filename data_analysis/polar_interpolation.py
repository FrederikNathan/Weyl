...
# print("")
# 
print(f"Dissipation             : {Diss/(Joule/second_physical/(millimeter**3)):>10.4} W/millimeter^2")
print(f"Work - dissipation (%)  : {around((-Diss-P1[0]-P2[0])/abs(Diss)*100,2):>10}%")
print("-"*80)
# (P1,P2),(std1,std2),rho,tw,parameters = DR.power_sweep([n0])
# print("") 
print(f"Conversion power        : {P2[0]/(Joule/second_physical/(millimeter**3)):>10.4} W/millimeter^3 (+/- {around(abs(std2[0]/P2[0])*100,1)}%)")#/(Joule/second/(micrometer**3)):>0.4} W/micrometer^2")
print("="*80)