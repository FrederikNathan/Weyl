...
Script for generating list of queues. Generating a 2d sweep at polar angle phi
...
omega2 = 20*THz
omega1 = omega2/1.5
omega1_list = [omega2/1.5,omega2/(1.5+pi/2000),omega2/(0.5*(1+sqrt(5)))]
...
# npr.seed(0)
klist = QG.get_kgrid_2d(phi,dk_i,dk_o)
NK = shape(klist)[0]
...
parameter_list = []
n_it = 0
for omega1 in omega1_list:
    queue_name = queue_list_name+f"_{n_it}"
