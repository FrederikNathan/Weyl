...
def get_ind(t,Nphi):
    ind1 = int(Nphi*t/T1+0.1*pi)%Nphi
    ind2 = int(Nphi*t/T2+0.1*pi)%Nphi
    return (ind1,ind2)
...
U_array,dt0=get_unitary_array(kgrid,dt=dt);
...
plot(tlist,abs(Rlist));#plot(tlist,array(i1list)/Nphi)
figure(2)
